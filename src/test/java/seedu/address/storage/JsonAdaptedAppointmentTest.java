...
public class JsonAdaptedAppointmentTest {
    ...
    public void toModelType_invalidDateTime_throwsIllegalValueException() {
        JsonAdaptedAppointment appt = new JsonAdaptedAppointment(
            INVALID_DATE_TIME, VALID_LENGTH, VALID_LOCATION,
    ...
    public void toModelType_nullDateTime_throwsIllegalValueException() {
        JsonAdaptedAppointment appt = new JsonAdaptedAppointment(
            null, VALID_LENGTH, VALID_LOCATION,
            VALID_TYPE, VALID_MESSAGE, VALID_STATUS);
    ...
    public void toModelType_invalidLength_throwsIllegalValueException() {
        JsonAdaptedAppointment appt = new JsonAdaptedAppointment(
            VALID_DATE_TIME, INVALID_LENGTH, VALID_LOCATION,
            VALID_TYPE, VALID_MESSAGE, VALID_STATUS);
    ...
    public void toModelType_invalidLocation_throwsIllegalValueException() {
        JsonAdaptedAppointment appt = new JsonAdaptedAppointment(
            VALID_DATE_TIME, VALID_LENGTH, INVALID_LOCATION,
            VALID_TYPE, VALID_MESSAGE, VALID_STATUS);
    ...
    public void toModelType_invalidStatus_throwsIllegalValueException() {
        JsonAdaptedAppointment appt = new JsonAdaptedAppointment(
            VALID_DATE_TIME, VALID_LENGTH, VALID_LOCATION,
